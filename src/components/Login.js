  ...
  return (
    ...
    <div className='absolute'>
      ...
      <div className='text-white absolute p-10 bg-black/80 rounded-md w-4/12 mx-auto mt-32 right-0 left-0 '>
        ...
        <form className='gap-5 flex flex-col mt-5 '>
          ...
          <input type='email' placeholder='Email Address' className='p-4 rounded-sm bg-white/10 text-white border border-white/50' />
          <input type='password' placeholder='Password' className=' p-4 rounded-sm bg-white/10 text-white border border-white/50' />
          <button className='w-full p-2 my-2 bg-[rgb(229,9,20)] rounded-md text-white'>Sign {isSignInForm === true ? "In" : "UP"}</button>
        </form>
